...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `47.6µs` | `48.2µs` |
| [Day 2](./src/bin/02.rs) | `753.1µs` | `1.5ms` |
| [Day 3](./src/bin/03.rs) | `41.4µs` | `54.9µs` |
| [Day 4](./src/bin/04.rs) | `63.0µs` | `146.8µs` |
| [Day 5](./src/bin/05.rs) | `89.7µs` | `8.5µs` |
